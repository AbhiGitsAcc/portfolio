    ...
    return (
        <>
            ...
            <div className='relative top-[72px] left-0 w-full'>
                <h2 className="my-12 text-center text-3xl text-backgroud-primary capitalize font-bold"> Contact me </h2>
                <section className="flex items-center py-8 bg-stone-50 justify-center font-poppins dark:bg-gray-800 ">
                    <div className="flex flex-wrap m-4 justify-center">
                        <div className="w-full px-4">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                Hello there! I would love to hear from you and discuss how I can collaborate on your next web development project. Whether you have a specific idea in mind or need guidance on how to turn your vision into reality, I am here to help.
                                </p>
